...
import springfox.documentation.spring.web.plugins.Docket;
	...
	.basePackage("org.generation.blogPessoal.controllers"))
	...
	.licenseUrl("https://github.com/PatriciaTorresGraciano")
	.contact(contact())
	.build();
	}
	private static Contact contact() {
	return new Contact("Patrícia Torres Graciano",
	"https://github.com/PatriciaTorresGraciano/blog_pessoal",
	"");
	}
